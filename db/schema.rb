...
ActiveRecord::Schema.define(version: 2021_03_31_071956) do
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.string "position"
    t.boolean "on_trade", default: false
  ...
  add_foreign_key "transfers", "users", column: "buyer_id"
  add_foreign_key "transfers", "users", column: "seller_id"
end
